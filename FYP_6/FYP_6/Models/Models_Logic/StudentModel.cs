...
namespace FYP_6.Models.Models_Logic
{
    public  class StudentModel
    {
        ...
        public  string[] WelcomeStudentScreenResults(string id)
        {
        ...
        public  List<Student_Marks> showMarks_StudentModelFunction(string Month, string Part, string id, int? y)
        {
        ...
        public  List<Students_Attendance> showAttendance_StudentModelFunction(string Month, string Part, string id, int? y)
        {
        ...
        public  List<Student_Marks> showMarks_StudentModelFunction(string id)
        {
            List<Student_Marks> listOfresults = new List<Student_Marks>();
        ...
        public  List<Students_Attendance> showAttendance_StudentModelFunction(string id)
        {
            List<Students_Attendance> listOfresults = new List<Students_Attendance>();
        ...
        public  Overall_Fees ShowFeeRecords_StudentModelFunction(string id)
        {
            try
            {
                var getFeeRecordOverallFee = rc.Overall_Fees.Where(s => s.RollNo == id).Select(s => s).FirstOrDefault();
                return getFeeRecordOverallFee;
            }
            catch (Exception)
            {
                return null;
        ...
        public  string ChangePassword_StudentModelFunction(string oldpass, string newpass, string id)
        {
        ...
        public  List<string> StudentDegreeDetail_StudentModel(string id)
        {
        ...
        public  List<string> getAllSubjectNames(string id)
        {
        ...
        public  List<int?> getStudentYears(string id)
        {
            if (id != null)
            {
