    ...
    public class SectionController : Controller
    {
        ...
        public ActionResult EditSection(string SectionID, Section sec)
        {
            try
            {
                ...
                try
                {
                    if ((sec.SectionName.ToLower() != getUpdatedRecord.SectionName.ToLower())
                        &&
                        r.Sections.Any(s => s.SectionName.ToLower() == sec.SectionName.ToLower()))
                    {
                        ViewBag.Message = "Section Name Already Exists";
        ...
        {   
                ...
                {
                    string result= SectionModel.AddSection(sec);
                    if (result=="OK")
                    {
