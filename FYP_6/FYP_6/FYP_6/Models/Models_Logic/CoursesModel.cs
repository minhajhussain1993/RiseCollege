...
namespace FYP_6.Models.Models_Logic
{
    public class CoursesModel
    {
        ...
        public static bool AddCourse(Guid level, Degree_Program deg)
        {
            //int degID = 0;
            try
            {
        ...
        public static bool CheckToSeeIfThereExistARecordWithSameDegreeNameAndSubject(Degree_Program deg, IEnumerable<Subject> subj)
        {
        ...
        public static bool DeleteRelatedBPSRecordsOnDeletionOfSubjects(IEnumerable<Degree_Subject> subjDeg)
        {
            try
            {
        ...
        public static IEnumerable<Degree_Subject> getSubjectsRelatedToDegree(Guid degID)
        {
            var degSubj = rc.Degree_Subject.Where(s => s.DegreeID == degID).OrderBy(s=>s.Part).Select(s => s);
            return degSubj;
        }
        public static IEnumerable<Subject> getSubjectsRelatedToDegreeForEditing()
        {
        ...
        public static string SubjectAddToDegree(IEnumerable<Guid> subj, Guid degID,int part)
        {
                try
                {
        ...
        public static bool AssignNewSubjects(List<Subject> listToDelete, 
        ...
        public static bool DeleteAllSubjects(Degree_Program deg,int part)
        {
        ...
        public static string DeleteAllDegreePrograms(IEnumerable<Guid> deleteCourses)
        {
            using (TransactionScope t=new TransactionScope())
            {
                try
